...
/**
 * Creates a PLEAVE PDU package from an inputStream.
 */
public class PDU_PLEAVE extends PDU {
    ...
    public PDU_PLEAVE(InputStream inputStream) throws IOException {
        byteSequenceBuilder = new ByteSequenceBuilder((byte)17);
        in = inputStream;
        ...
        bA= new byte[1];int toPad =
                identityLenght % 4 == 0 ? 0 : 4 - (identityLenght % 4);
